...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            "/lium/buster1/tprouteau/miniconda3/envs/spacy_transformer/lib/python3.8/site-packages/numpy/core/include"
        ],
        "language": "c++",
        "libraries": [
            "stdc++"
        ],
        "name": "sinr.cooccurrence_cython",
        "sources": [
            "sinr/cooccurrence_cython.pyx"
        ]
    },
    "module_name": "sinr.cooccurrence_cython"
}
END: Cython Metadata */
...
#define __PYX_HAVE__sinr__cooccurrence_cython
#define __PYX_HAVE_API__sinr__cooccurrence_cython
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include "ios"
...
struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix;

/* "sinr/cooccurrence_cython.pyx":42
 * 
 * 
...
/* Module declarations from 'sinr.cooccurrence_cython' */
...
static CYTHON_INLINE int __pyx_f_4sinr_19cooccurrence_cython_int_min(int, int); /*proto*/
static int __pyx_f_4sinr_19cooccurrence_cython_binary_search(int *, int, int, int, int); /*proto*/
static struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *__pyx_f_4sinr_19cooccurrence_cython_new_matrix(void); /*proto*/
static void __pyx_f_4sinr_19cooccurrence_cython_free_matrix(struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *); /*proto*/
static void __pyx_f_4sinr_19cooccurrence_cython_increment_matrix(struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *, int, int, float); /*proto*/
static int __pyx_f_4sinr_19cooccurrence_cython_matrix_nnz(struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *); /*proto*/
static PyObject *__pyx_f_4sinr_19cooccurrence_cython_matrix_to_coo(struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *, int); /*proto*/
static int __pyx_f_4sinr_19cooccurrence_cython_words_to_ids(PyObject *, std::vector<int>  &, PyObject *); /*proto*/
...
#define __Pyx_MODULE_NAME "sinr.cooccurrence_cython"
extern int __pyx_module_is_main_sinr__cooccurrence_cython;
int __pyx_module_is_main_sinr__cooccurrence_cython = 0;

/* Implementation of 'sinr.cooccurrence_cython' */
...
static const char __pyx_k_sinr_cooccurrence_cython[] = "sinr.cooccurrence_cython";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_sinr_cooccurrence_cython_pyx[] = "sinr/cooccurrence_cython.pyx";
...
static PyObject *__pyx_n_s_sinr_cooccurrence_cython;
static PyObject *__pyx_kp_s_sinr_cooccurrence_cython_pyx;
...
static PyObject *__pyx_pf_4sinr_19cooccurrence_cython_construct_cooccurrence_matrix(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_corpus, PyObject *__pyx_v_dictionary, int __pyx_v_window_size); /* proto */
...
/* "sinr/cooccurrence_cython.pyx":15
 * 
 * 
...
static CYTHON_INLINE int __pyx_f_4sinr_19cooccurrence_cython_int_min(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
  int __pyx_t_1;
...
/* "sinr/cooccurrence_cython.pyx":18
 * 
 * 
...
static int __pyx_f_4sinr_19cooccurrence_cython_binary_search(int *__pyx_v_vec, int __pyx_v_size, int __pyx_v_first, int __pyx_v_last, int __pyx_v_x) {
  int __pyx_v_mid;
  int __pyx_r;
  int __pyx_t_1;

  /* "sinr/cooccurrence_cython.pyx":25
 *     cdef int mid
 * 
 *     while (first < last):             # <<<<<<<<<<<<<<
 *         mid = (first + last) / 2
 ...
 */
  while (1) {
    ...
    /* "sinr/cooccurrence_cython.pyx":26
 * 
 *     while (first < last):
 *         mid = (first + last) / 2             # <<<<<<<<<<<<<<
 *         if (vec[mid] == x):
 ...
 */
    ...
    /* "sinr/cooccurrence_cython.pyx":27
 *     while (first < last):
 *         mid = (first + last) / 2
 *         if (vec[mid] == x):             # <<<<<<<<<<<<<<
 *             return mid
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "sinr/cooccurrence_cython.pyx":28
 *         mid = (first + last) / 2
 *         if (vec[mid] == x):
 *             return mid             # <<<<<<<<<<<<<<
 *         elif vec[mid] > x:
 ...
 */
    ...
    /* "sinr/cooccurrence_cython.pyx":29
 *         if (vec[mid] == x):
 *             return mid
 *         elif vec[mid] > x:             # <<<<<<<<<<<<<<
 *             last = mid - 1
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "sinr/cooccurrence_cython.pyx":30
 *             return mid
 *         elif vec[mid] > x:
 *             last = mid - 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "sinr/cooccurrence_cython.pyx":32
 *             last = mid - 1
 *         else:
 *             first = mid + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":34
 *             first = mid + 1
 * 
 *     if (first == size):             # <<<<<<<<<<<<<<
 *         return first
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "sinr/cooccurrence_cython.pyx":35
 * 
 *     if (first == size):
 *         return first             # <<<<<<<<<<<<<<
 *     elif vec[first] > x:
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":36
 *     if (first == size):
 *         return first
 *     elif vec[first] > x:             # <<<<<<<<<<<<<<
 *         return first
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "sinr/cooccurrence_cython.pyx":37
 *         return first
 *     elif vec[first] > x:
 *         return first             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":39
 *         return first
 *     else:
 *         return first + 1             # <<<<<<<<<<<<<<
 * 
...
/* "sinr/cooccurrence_cython.pyx":47
 * 
 * 
...
static struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *__pyx_f_4sinr_19cooccurrence_cython_new_matrix(void) {
  struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *__pyx_v_mat;
  struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *__pyx_r;
  ...
  /* "sinr/cooccurrence_cython.pyx":54
 ...
 *     if mat == NULL:
 */
  __pyx_v_mat = ((struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *)malloc((sizeof(struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix))));

  /* "sinr/cooccurrence_cython.pyx":56
 *     mat = <SparseRowMatrix*>malloc(sizeof(SparseRowMatrix))
 * 
 *     if mat == NULL:             # <<<<<<<<<<<<<<
 *         raise MemoryError()
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "sinr/cooccurrence_cython.pyx":57
 * 
 *     if mat == NULL:
 *         raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":59
 *         raise MemoryError()
 * 
 *     mat.indices = new vector[vector[int]]()             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":60
 * 
 *     mat.indices = new vector[vector[int]]()
 *     mat.data = new vector[vector[float]]()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":62
 *     mat.data = new vector[vector[float]]()
 * 
 *     return mat             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("sinr.cooccurrence_cython.new_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "sinr/cooccurrence_cython.pyx":65
 * 
 * 
...
static void __pyx_f_4sinr_19cooccurrence_cython_free_matrix(struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *__pyx_v_mat) {
  int __pyx_v_i;
  int __pyx_v_rows;
  int __pyx_t_1;
  int __pyx_t_2;
  ...
  /* "sinr/cooccurrence_cython.pyx":75
 * 
 *     cdef int i
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":77
 *     cdef int rows = mat.indices.size()
 * 
 *     for i in range(rows):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "sinr/cooccurrence_cython.pyx":78
 * 
 *     for i in range(rows):
 *         deref(mat.indices)[i].clear()             # <<<<<<<<<<<<<<
 *         deref(mat.data)[i].clear()
 ...
 */
    ...
    /* "sinr/cooccurrence_cython.pyx":79
 *     for i in range(rows):
 *         deref(mat.indices)[i].clear()
 *         deref(mat.data)[i].clear()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":81
 *         deref(mat.data)[i].clear()
 * 
 *     del mat.indices             # <<<<<<<<<<<<<<
 *     del mat.data
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":82
 * 
 *     del mat.indices
 *     del mat.data             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":84
 *     del mat.data
 * 
 *     free(mat)             # <<<<<<<<<<<<<<
 * 
...
/* "sinr/cooccurrence_cython.pyx":87
 * 
 * 
...
static void __pyx_f_4sinr_19cooccurrence_cython_increment_matrix(struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *__pyx_v_mat, int __pyx_v_row, int __pyx_v_col, float __pyx_v_increment) {
  ...
  /* "sinr/cooccurrence_cython.pyx":103
 * 
 ...
 */
  while (1) {
    ...
    /* "sinr/cooccurrence_cython.pyx":104
 *     # Add new row if necessary
 *     while row >= mat.indices.size():
 *         mat.indices.push_back(vector[int]())             # <<<<<<<<<<<<<<
 *         mat.data.push_back(vector[float]())
 ...
 */
    ...
    /* "sinr/cooccurrence_cython.pyx":105
 *     while row >= mat.indices.size():
 *         mat.indices.push_back(vector[int]())
 *         mat.data.push_back(vector[float]())             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":107
 *         mat.data.push_back(vector[float]())
 * 
 *     row_indices = &(deref(mat.indices)[row])             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":108
 * 
 *     row_indices = &(deref(mat.indices)[row])
 *     row_data = &(deref(mat.data)[row])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":112
 *     # Find the column element, or the position where
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "sinr/cooccurrence_cython.pyx":113
 *     # a new element should be inserted
 *     if row_indices.size() == 0:
 *         idx = 0             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":115
 *         idx = 0
 *     else:
 *         idx = binary_search(&(deref(row_indices)[0]), row_indices.size(),             # <<<<<<<<<<<<<<
 ...
 */
  /*else*/ {
    ...
    /* "sinr/cooccurrence_cython.pyx":116
 *     else:
 *         idx = binary_search(&(deref(row_indices)[0]), row_indices.size(),
 *                             0, row_indices.size(), col)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_idx = __pyx_f_4sinr_19cooccurrence_cython_binary_search((&((*__pyx_v_row_indices)[0])), __pyx_v_row_indices->size(), 0, __pyx_v_row_indices->size(), __pyx_v_col);
  }
  __pyx_L5:;

  /* "sinr/cooccurrence_cython.pyx":119
 * 
 *     # Element to be added at the end
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "sinr/cooccurrence_cython.pyx":120
 *     # Element to be added at the end
 *     if idx == row_indices.size():
 *         row_indices.insert(row_indices.begin() + idx, col)             # <<<<<<<<<<<<<<
 *         row_data.insert(row_data.begin() + idx, increment)
 ...
 */
    ...
    /* "sinr/cooccurrence_cython.pyx":121
 *     if idx == row_indices.size():
 *         row_indices.insert(row_indices.begin() + idx, col)
 *         row_data.insert(row_data.begin() + idx, increment)             # <<<<<<<<<<<<<<
 *         return
 ...
 */
    ...
    /* "sinr/cooccurrence_cython.pyx":122
 *         row_indices.insert(row_indices.begin() + idx, col)
 *         row_data.insert(row_data.begin() + idx, increment)
 *         return             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":124
 *         return
 * 
 *     col_at_idx = deref(row_indices)[idx]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":126
 *     col_at_idx = deref(row_indices)[idx]
 * 
 *     if col_at_idx == col:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "sinr/cooccurrence_cython.pyx":128
 *     if col_at_idx == col:
 *         # Element to be incremented
 *         deref(row_data)[idx] = deref(row_data)[idx] + increment             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":131
 *     else:
 *         # Element to be inserted
 *         row_indices.insert(row_indices.begin() + idx, col)             # <<<<<<<<<<<<<<
 *         row_data.insert(row_data.begin() + idx, increment)
 ...
 */
  /*else*/ {
    ...
    /* "sinr/cooccurrence_cython.pyx":132
 *         # Element to be inserted
 *         row_indices.insert(row_indices.begin() + idx, col)
 *         row_data.insert(row_data.begin() + idx, increment)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("sinr.cooccurrence_cython.increment_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* "sinr/cooccurrence_cython.pyx":135
 * 
 * 
...
static int __pyx_f_4sinr_19cooccurrence_cython_matrix_nnz(struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *__pyx_v_mat) {
  int __pyx_v_i;
  int __pyx_v_size;
  int __pyx_r;
  ...
  /* "sinr/cooccurrence_cython.pyx":144
 * 
 *     cdef int i
 *     cdef int size = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":146
 *     cdef int size = 0
 * 
 *     for i in range(mat.indices.size()):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "sinr/cooccurrence_cython.pyx":147
 * 
 *     for i in range(mat.indices.size()):
 *         size += deref(mat.indices)[i].size()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":149
 *         size += deref(mat.indices)[i].size()
 * 
 *     return size             # <<<<<<<<<<<<<<
 * 
...
/* "sinr/cooccurrence_cython.pyx":152
 * 
 * 
...
static PyObject *__pyx_f_4sinr_19cooccurrence_cython_matrix_to_coo(struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *__pyx_v_mat, int __pyx_v_shape) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_row;
  int __pyx_v_rows;
  ...
  /* "sinr/cooccurrence_cython.pyx":168
 *     cdef int row
 *     cdef int col
 *     cdef int rows = mat.indices.size()             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":169
 *     cdef int col
 *     cdef int rows = mat.indices.size()
 *     cdef int no_collocations = matrix_nnz(mat)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_no_collocations = __pyx_f_4sinr_19cooccurrence_cython_matrix_nnz(__pyx_v_mat);

  /* "sinr/cooccurrence_cython.pyx":172
 * 
 *     # Create the constituent numpy arrays.
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_empty); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 172, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_no_collocations); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 172, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_int32); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 172, __pyx_L1_error)
  ...
  /* "sinr/cooccurrence_cython.pyx":173
 *     # Create the constituent numpy arrays.
 *     row_np = np.empty(no_collocations, dtype=np.int32)
 *     col_np = np.empty(no_collocations, dtype=np.int32)             # <<<<<<<<<<<<<<
 *     data_np = np.empty(no_collocations, dtype=np.float64)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_empty); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 173, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_no_collocations); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 173, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_int32); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 173, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_4) < 0) __PYX_ERR(0, 173, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 173, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  /* "sinr/cooccurrence_cython.pyx":174
 *     row_np = np.empty(no_collocations, dtype=np.int32)
 *     col_np = np.empty(no_collocations, dtype=np.int32)
 *     data_np = np.empty(no_collocations, dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef int[:] row_view = row_np
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_empty); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 174, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_no_collocations); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 174, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_float64); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 174, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_t_2) < 0) __PYX_ERR(0, 174, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_3, __pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 174, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  /* "sinr/cooccurrence_cython.pyx":175
 *     col_np = np.empty(no_collocations, dtype=np.int32)
 *     data_np = np.empty(no_collocations, dtype=np.float64)
 *     cdef int[:] row_view = row_np             # <<<<<<<<<<<<<<
 *     cdef int[:] col_view = col_np
 ...
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_v_row_np, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 175, __pyx_L1_error)
  __pyx_v_row_view = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "sinr/cooccurrence_cython.pyx":176
 *     data_np = np.empty(no_collocations, dtype=np.float64)
 *     cdef int[:] row_view = row_np
 *     cdef int[:] col_view = col_np             # <<<<<<<<<<<<<<
 *     cdef double[:] data_view = data_np
 * 
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_v_col_np, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 176, __pyx_L1_error)
  __pyx_v_col_view = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "sinr/cooccurrence_cython.pyx":177
 *     cdef int[:] row_view = row_np
 *     cdef int[:] col_view = col_np
 *     cdef double[:] data_view = data_np             # <<<<<<<<<<<<<<
 * 
 *     j = 0
 */
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_data_np, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 177, __pyx_L1_error)
  __pyx_v_data_view = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "sinr/cooccurrence_cython.pyx":179
 *     cdef double[:] data_view = data_np
 * 
 *     j = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":181
 *     j = 0
 * 
 *     for row in range(rows):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "sinr/cooccurrence_cython.pyx":182
 * 
 *     for row in range(rows):
 *         for i in range(deref(mat.indices)[row].size()):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      ...
      /* "sinr/cooccurrence_cython.pyx":184
 *         for i in range(deref(mat.indices)[row].size()):
 * 
 *             row_view[j] = row             # <<<<<<<<<<<<<<
 ...
 */
      ...
      *((int *) ( /* dim=0 */ (__pyx_v_row_view.data + __pyx_t_14 * __pyx_v_row_view.strides[0]) )) = __pyx_v_row;
      ...
      /* "sinr/cooccurrence_cython.pyx":185
 * 
 *             row_view[j] = row
 *             col_view[j] = deref(mat.indices)[row][i]             # <<<<<<<<<<<<<<
 *             data_view[j] = deref(mat.data)[row][i]
 ...
 */
      ...
      *((int *) ( /* dim=0 */ (__pyx_v_col_view.data + __pyx_t_14 * __pyx_v_col_view.strides[0]) )) = (((*__pyx_v_mat->indices)[__pyx_v_row])[__pyx_v_i]);
      ...
      /* "sinr/cooccurrence_cython.pyx":186
 *             row_view[j] = row
 *             col_view[j] = deref(mat.indices)[row][i]
 *             data_view[j] = deref(mat.data)[row][i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_data_view.data + __pyx_t_14 * __pyx_v_data_view.strides[0]) )) = (((*__pyx_v_mat->data)[__pyx_v_row])[__pyx_v_i]);
      ...
      /* "sinr/cooccurrence_cython.pyx":188
 *             data_view[j] = deref(mat.data)[row][i]
 * 
 *             j += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":191
 * 
 *     # Create and return the matrix.
 ...
 */
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_sp); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 191, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_coo_matrix); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 191, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "sinr/cooccurrence_cython.pyx":192
 *     # Create and return the matrix.
 *     return sp.coo_matrix((data_np, (row_np, col_np)),
 *                          shape=(shape,             # <<<<<<<<<<<<<<
 *                                 shape),
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_shape); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 192, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);

  /* "sinr/cooccurrence_cython.pyx":193
 *     return sp.coo_matrix((data_np, (row_np, col_np)),
 *                          shape=(shape,
 *                                 shape),             # <<<<<<<<<<<<<<
 *                          dtype=np.float64)
 * 
 */
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_shape); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 193, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __pyx_t_5 = 0;
  __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_shape, __pyx_t_15) < 0) __PYX_ERR(0, 192, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;

  /* "sinr/cooccurrence_cython.pyx":194
 *                          shape=(shape,
 *                                 shape),
 *                          dtype=np.float64)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_15);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_15, __pyx_n_s_float64); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 194, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_t_1) < 0) __PYX_ERR(0, 192, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *                                 shape),
 */
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_2, __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 191, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("sinr.cooccurrence_cython.matrix_to_coo", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "sinr/cooccurrence_cython.pyx":197
 * 
 * 
...
static int __pyx_f_4sinr_19cooccurrence_cython_words_to_ids(PyObject *__pyx_v_words, std::vector<int>  &__pyx_v_word_ids, PyObject *__pyx_v_dictionary) {
  int __pyx_v_word_id;
  ...
  /* "sinr/cooccurrence_cython.pyx":226
 *     cdef int word_id
 * 
 *     word_ids.resize(0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":229
 * 
 * 
 *     for word in words:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (;;) {
    ...
    /* "sinr/cooccurrence_cython.pyx":233
 *        # is missing from the supplied
 *        # dictionary.
 ...
 *             return -1
 */
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_dictionary, __pyx_n_s_get); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 233, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = NULL;
    __pyx_t_6 = 0;
    ...
    if (PyFunction_Check(__pyx_t_4)) {
      ...
      __pyx_t_3 = __Pyx_PyFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_6, 2+__pyx_t_6); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 233, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_4)) {
      PyObject *__pyx_temp[3] = {__pyx_t_5, __pyx_v_word, __pyx_int_neg_1};
      __pyx_t_3 = __Pyx_PyCFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_6, 2+__pyx_t_6); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 233, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_GOTREF(__pyx_t_3);
    } else
    #endif
    {
      ...
      __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_7, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 233, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    }
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_6 = __Pyx_PyInt_As_int(__pyx_t_3); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 233, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_v_word_id = __pyx_t_6;

    /* "sinr/cooccurrence_cython.pyx":234
 *        # dictionary.
 *         word_id = dictionary.get(word, -1)
 *         if word_id == -1:             # <<<<<<<<<<<<<<
 *             return -1
 * 
 */
    __pyx_t_8 = ((__pyx_v_word_id == -1L) != 0);
    if (__pyx_t_8) {

      /* "sinr/cooccurrence_cython.pyx":235
 *         word_id = dictionary.get(word, -1)
 *         if word_id == -1:
 *             return -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "sinr/cooccurrence_cython.pyx":237
 *             return -1
 * 
 *         word_ids.push_back(word_id)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":239
 *         word_ids.push_back(word_id)
 * 
 *     return 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_WriteUnraisable("sinr.cooccurrence_cython.words_to_ids", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "sinr/cooccurrence_cython.pyx":242
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_4sinr_19cooccurrence_cython_1construct_cooccurrence_matrix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4sinr_19cooccurrence_cython_construct_cooccurrence_matrix[] = "\n    Construct the word-id dictionary and cooccurrence matrix for\n    a given corpus, using a given window size.\n    \n    The dictionary is constructed by lexicographix order.\n    The matrix accounts for the number of cooccurrences of words, no matter the\n    order in which they appear in the corpus. Consequently, the cooccurrence\n    matrix is upper triangular (undirected graph in SINr) .\n\n   :param corpus: The sentences from the corpus.\n   :type corpus: `list(str)`\n   :param dictionary: A dictionary mapping of words to their ids in the vocabulary (in lexicographic order)\n   :type dictionary: `dict`\n   :param window_size: The size of the symmetric moving window.\n   :type window_size: `int`\n\n   :return: The cooccurrence matrix built from the corpus.\n   :rtype: `scipy.sparse.coo`\n    ";
static PyMethodDef __pyx_mdef_4sinr_19cooccurrence_cython_1construct_cooccurrence_matrix = {"construct_cooccurrence_matrix", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4sinr_19cooccurrence_cython_1construct_cooccurrence_matrix, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4sinr_19cooccurrence_cython_construct_cooccurrence_matrix};
static PyObject *__pyx_pw_4sinr_19cooccurrence_cython_1construct_cooccurrence_matrix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_corpus,&__pyx_n_s_dictionary,&__pyx_n_s_window_size,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dictionary)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("construct_cooccurrence_matrix", 1, 3, 3, 1); __PYX_ERR(0, 242, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_window_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("construct_cooccurrence_matrix", 1, 3, 3, 2); __PYX_ERR(0, 242, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "construct_cooccurrence_matrix") < 0)) __PYX_ERR(0, 242, __pyx_L3_error)
      }
    ...
    __pyx_v_window_size = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_window_size == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 242, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("construct_cooccurrence_matrix", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 242, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("sinr.cooccurrence_cython.construct_cooccurrence_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4sinr_19cooccurrence_cython_construct_cooccurrence_matrix(__pyx_self, __pyx_v_corpus, __pyx_v_dictionary, __pyx_v_window_size);
...
static PyObject *__pyx_pf_4sinr_19cooccurrence_cython_construct_cooccurrence_matrix(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_corpus, PyObject *__pyx_v_dictionary, int __pyx_v_window_size) {
  struct __pyx_t_4sinr_19cooccurrence_cython_SparseRowMatrix *__pyx_v_matrix;
  ...
  /* "sinr/cooccurrence_cython.pyx":264
 * 
 ...
 */
  __pyx_v_matrix = __pyx_f_4sinr_19cooccurrence_cython_new_matrix();

  /* "sinr/cooccurrence_cython.pyx":274
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":279
 * 
 ...
 */
  if (likely(PyList_CheckExact(__pyx_v_corpus)) || PyTuple_CheckExact(__pyx_v_corpus)) {
    ...
    __pyx_t_2 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_v_corpus); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 279, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
  ...
  for (;;) {
    ...
    if (!(likely(PyList_CheckExact(__pyx_t_4))||((__pyx_t_4) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_t_4)->tp_name), 0))) __PYX_ERR(0, 279, __pyx_L1_error)
    __Pyx_XDECREF_SET(__pyx_v_words, ((PyObject*)__pyx_t_4));
    __pyx_t_4 = 0;

    /* "sinr/cooccurrence_cython.pyx":282
 * 
 *         # Convert words to a numeric vector.
 ...
 */
    __pyx_v_error = __pyx_f_4sinr_19cooccurrence_cython_words_to_ids(__pyx_v_words, __pyx_v_word_ids, __pyx_v_dictionary);

    /* "sinr/cooccurrence_cython.pyx":284
 *         error = words_to_ids(words, word_ids, dictionary)
 * 
 *         wordslen = word_ids.size()             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "sinr/cooccurrence_cython.pyx":287
 * 
 *         # Record co-occurrences in a moving window.
 ...
 * 
 */
    __pyx_t_5 = __pyx_v_wordslen;
    __pyx_t_6 = __pyx_t_5;
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v_i = __pyx_t_7;

      /* "sinr/cooccurrence_cython.pyx":288
 *         # Record co-occurrences in a moving window.
 *         for i in range(wordslen):
 *             outer_word = word_ids[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "sinr/cooccurrence_cython.pyx":291
 * 
 *             # Continue if we have an OOD token.
 *             if outer_word == -1:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_8) {
        ...
        /* "sinr/cooccurrence_cython.pyx":292
 *             # Continue if we have an OOD token.
 *             if outer_word == -1:
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "sinr/cooccurrence_cython.pyx":294
 *                 continue
 * 
 *             window_stop = int_min(i + window_size + 1, wordslen)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_window_stop = __pyx_f_4sinr_19cooccurrence_cython_int_min(((__pyx_v_i + __pyx_v_window_size) + 1), __pyx_v_wordslen);

      /* "sinr/cooccurrence_cython.pyx":296
 *             window_stop = int_min(i + window_size + 1, wordslen)
 * 
 *             for j in range(i, window_stop):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      for (__pyx_t_11 = __pyx_v_i; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
        ...
        /* "sinr/cooccurrence_cython.pyx":297
 * 
 *             for j in range(i, window_stop):
 *                 inner_word = word_ids[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "sinr/cooccurrence_cython.pyx":299
 *                 inner_word = word_ids[j]
 * 
 *                 if inner_word == -1:             # <<<<<<<<<<<<<<
 *                     continue
 ...
 */
        ...
        if (__pyx_t_8) {
          ...
          /* "sinr/cooccurrence_cython.pyx":300
 * 
 *                 if inner_word == -1:
 *                     continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "sinr/cooccurrence_cython.pyx":303
 * 
 *                 # Do nothing if the words are the same.
 ...
 */
        ...
        if (__pyx_t_8) {
          ...
          /* "sinr/cooccurrence_cython.pyx":304
 *                 # Do nothing if the words are the same.
 *                 if inner_word == outer_word:
 *                     continue             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
        ...
        /* "sinr/cooccurrence_cython.pyx":307
 *                 else:
 *                 # Each cooccurrence is counted as 1, cooccurrence(w_1, w_2) == cooccurrence(w_2, w_1) because the graph is undirected in SINr, subsequently, the matrix is upper triangular with cooccurrence(w_i, w_i) == 0
 *                     if inner_word < outer_word:             # <<<<<<<<<<<<<<
 ...
 */
        /*else*/ {
          ...
          if (__pyx_t_8) {
            ...
            /* "sinr/cooccurrence_cython.pyx":308
 *                 # Each cooccurrence is counted as 1, cooccurrence(w_1, w_2) == cooccurrence(w_2, w_1) because the graph is undirected in SINr, subsequently, the matrix is upper triangular with cooccurrence(w_i, w_i) == 0
 *                     if inner_word < outer_word:
 *                         increment_matrix(matrix,             # <<<<<<<<<<<<<<
 *                                          inner_word,
 *                                          outer_word,
 */
            __pyx_f_4sinr_19cooccurrence_cython_increment_matrix(__pyx_v_matrix, __pyx_v_inner_word, __pyx_v_outer_word, 2.0);
 ...
 */
          ...
          /* "sinr/cooccurrence_cython.pyx":313
 ...
 */
          /*else*/ {
            ...
            /* "sinr/cooccurrence_cython.pyx":315
 *                         increment_matrix(matrix,
 *                                          outer_word,
 *                                          inner_word,             # <<<<<<<<<<<<<<
 *                                          2)
 * 
 */
            __pyx_f_4sinr_19cooccurrence_cython_increment_matrix(__pyx_v_matrix, __pyx_v_outer_word, __pyx_v_inner_word, 2.0);
          }
          __pyx_L12:;
        }
        __pyx_L8_continue:;
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":328
 * 
 *     # Create the matrix.
 ...
 * 
 */
  __pyx_t_2 = PyObject_Length(__pyx_v_dictionary); if (unlikely(__pyx_t_2 == ((Py_ssize_t)-1))) __PYX_ERR(0, 328, __pyx_L1_error)
  __pyx_t_1 = __pyx_f_4sinr_19cooccurrence_cython_matrix_to_coo(__pyx_v_matrix, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 328, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_mat = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "sinr/cooccurrence_cython.pyx":329
 *     # Create the matrix.
 *     mat = matrix_to_coo(matrix, len(dictionary))
 *     free_matrix(matrix)             # <<<<<<<<<<<<<<
 * 
 *     return mat
 */
  __pyx_f_4sinr_19cooccurrence_cython_free_matrix(__pyx_v_matrix);

  /* "sinr/cooccurrence_cython.pyx":331
 *     free_matrix(matrix)
 * 
 *     return mat             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "sinr.cooccurrence_cython.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "sinr.cooccurrence_cython.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "sinr.cooccurrence_cython.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "sinr.cooccurrence_cython._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_cooccurrence_cython(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cooccurrence_cython},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_sinr_cooccurrence_cython, __pyx_k_sinr_cooccurrence_cython, sizeof(__pyx_k_sinr_cooccurrence_cython), 0, 0, 1, 1},
  {&__pyx_kp_s_sinr_cooccurrence_cython_pyx, __pyx_k_sinr_cooccurrence_cython_pyx, sizeof(__pyx_k_sinr_cooccurrence_cython_pyx), 0, 0, 1, 0},
 ...
 *     Construct the word-id dictionary and cooccurrence matrix for
 */
  __pyx_tuple__20 = PyTuple_Pack(14, __pyx_n_s_corpus, __pyx_n_s_dictionary, __pyx_n_s_window_size, __pyx_n_s_matrix, __pyx_n_s_words, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_outer_word, __pyx_n_s_inner_word, __pyx_n_s_wordslen, __pyx_n_s_window_stop, __pyx_n_s_error, __pyx_n_s_word_ids, __pyx_n_s_mat); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 242, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(3, 0, 14, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_sinr_cooccurrence_cython_pyx, __pyx_n_s_construct_cooccurrence_matrix, 242, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 242, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcooccurrence_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcooccurrence_cython(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cooccurrence_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cooccurrence_cython(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cooccurrence_cython(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cooccurrence_cython' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cooccurrence_cython(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cooccurrence_cython", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_sinr__cooccurrence_cython) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "sinr.cooccurrence_cython")) {
      if (unlikely(PyDict_SetItemString(modules, "sinr.cooccurrence_cython", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "sinr/cooccurrence_cython.pyx":5
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":6
 * 
 * import numpy as np
 * import scipy.sparse as sp             # <<<<<<<<<<<<<<
 * import itertools
 ...
 */
  ...
  /* "sinr/cooccurrence_cython.pyx":7
 * import numpy as np
 * import scipy.sparse as sp
 * import itertools             # <<<<<<<<<<<<<<
 * 
 ...
 *     Construct the word-id dictionary and cooccurrence matrix for
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_4sinr_19cooccurrence_cython_1construct_cooccurrence_matrix, NULL, __pyx_n_s_sinr_cooccurrence_cython); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 242, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_construct_cooccurrence_matrix, __pyx_t_2) < 0) __PYX_ERR(0, 242, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "sinr/cooccurrence_cython.pyx":1
 * #!python             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init sinr.cooccurrence_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init sinr.cooccurrence_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
