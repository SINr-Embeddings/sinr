...
if __name__ == "__main__":
    ...
    for dataset in datasets: 
        with open(path_pickles+dataset+extension, 'rb') as f:
            ...
            #test_diachrony(diachrony.DiachronicModels.static_factory,sinr_objects,dataset)
            #test_diachrony(diachrony.DiachronicModels.multilayer_factory,sinr_objects,dataset)
            test_diachrony(diachrony.DiachronicModels.multislices_factory,sinr_objects,dataset)
